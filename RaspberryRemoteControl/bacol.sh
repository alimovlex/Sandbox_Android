...
rm -rf gen obj compiled_res out my-release-key.keystore
...
#sign --key-pass pass:password --ks-pass pass:password --ks my-release-key.keystore --out out/app_signed.apk out/app_unsigned.apk
...
adb shell am start -n com.raspberryremotecontrol/.MainActivity
